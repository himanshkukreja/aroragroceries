...
if (isset($_POST['suggestion'])) {
    ...
    if ($is_a_user) {
        ...
        $query = "SELECT * FROM `suggestions` WHERE `email` = '$email' AND `suggestion` = '$suggestion'";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 m-b30">
                            <form class="inquiry-form wow box-shadow bg-white fadeInUp" data-wow-delay="0.2s" method="POST" action="http://localhost/aroragrceries/contact.php" <?php if ($is_done) {
                                                                                                                                                                                    echo 'style="display: none"';
                                                                                                                                                                                } ?>>
                                <h3 class="title-box font-weight-300 m-t0 m-b10">Let's Convert Your Idea into Reality <span class="bg-primary"></span></h3>
                                <p>tell us you suggestion we will surely look at you it will try to apply to the website as soon as possible.</p>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="ti-user text-primary"></i></span>
                                                <input name="name" type="text" required class="form-control" placeholder="Name" <?php if (isset($data)) {
                                                                                                                                    echo 'value="' . $data['first_name'] . '  ' . $data['last_name'] . '"';
                                                                                                                                } ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input name="mobile" type="text" required class="form-control" placeholder="Phone" <?php if (isset($data)) {
                                                                                                                                        echo 'value="' . $data['mobile'] . '"';
                                                                                                                                    } ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input name="email" type="email" class="form-control" required placeholder="Your Email Id" <?php if (isset($data)) {
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select name="type">
                                                    <option>Reagarding Product Addition</option>
                                                    <option>Regarding Website</option>
                                                </select>
                                                <input type="hidden" name="is_a_user" <?php if (isset($data)) {
                                                                                            echo 'value="1"';
                                                                                        } else {
                                                                                            echo 'value=0';
                                                                                        } ?>>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <textarea name="suggestion" rows="4" class="form-control" required placeholder="Tell us about idea"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <button name="submit" type="submit" value="Submit" class="site-button button-md"> <span>Submit!</span> </button>
                                    </div>
                                </div>
                            </form>

                            <div class="section-full content-inner bg-gray" <?php if (!$is_done) {
                                                                                echo 'style="display: none;"';
                                                                            } ?>>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-8 col-md-12">
                                            <div class="section-head text-black">
                                                <h4 class="text-primary-dark font-weight-300 m-b10">Thank You!</h4>
                                                <h2 class="title">Thanks For Your Valuable Suggestion</h2>
                                                <p>We will certainly pay heed toward it and will try to implement it as soon as posible.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
