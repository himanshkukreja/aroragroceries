			...
			<div class="container clearfix">
				...
				<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
					...
					<ul class="nav navbar-nav">
						...
						<li class="has-mega-menu"> <a href="http://localhost/aroragrceries/#products">Products</a></li>
						<li class="has-mega-menu"> <a href="http://localhost/aroragrceries/login.php">Login</a></li>
