    ...
    <div class="page-wraper">
        ...
        <div class="page-content bg-white">
            <div class="section-full content-inner">
                ...
                <?php
                $query = "SELECT * FROM `products` WHERE `products`.`type` = '$type' ORDER BY `no_of_orders` DESC";
                $result = mysqli_query($conn, $query);

                $no_of_total_searches = mysqli_num_rows($result);
                $total_page = ceil($no_of_total_searches / 8);
                $start = ($page - 1) * 8;
                $query = "SELECT * FROM `products` WHERE `products`.`type` = '$type' ORDER BY `no_of_orders` DESC LIMIT $start, 8";
                $result = mysqli_query($conn, $query);
                        ...
                        <div class="col-lg-2 col-md-12">
                            ...
                            <div class="section-content box-sort-in m-b15">
                                <div class="pagination-bx primary rounded clearfix">
                                    <ul class="pagination">
                                        <li class="previous"><a href="http://localhost/aroragrceries/product_for_a_type.php?type=<?php echo $type;?>&page=<?php
                                                                                                                                    if ($page == 0) {
                                                                                                                                        echo $page;
                                                                                                                                    } elseif ($page == 1) {
                                                                                                                                        echo $total_page;
                                        ...
                                        <li class="next pull-right"><a href="http://localhost/aroragrceries/product_for_a_type.php?type=<?php echo $type;?>&page=<?php
                                                                                                                                        if ($page == 0) {
                                                                                                                                            echo $page;
